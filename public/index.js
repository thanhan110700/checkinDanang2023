  ...
  var g = {
    init: function (i) {
      ...
      (P.onload = u),
        ...
        (o = i.playSound),
        e(this).append(
          '<canvas id="myCanvas" style="height: 500px; width: 500px; background-position: center; background-size: cover;"></canvas>'
        ),
        e(this).append("</br>"),
        e(this).append(
      ...
      var O = -1.5;
      r = [
        T(0, C.width / 2, C.height - 30, O, 2, a / 5),
        T(1, C.width / 3, C.height - 50, O, 2, a / 5),
        T(2, C.width / 4, C.height - 60, O, 2, a / 5),
        T(3, C.width / 2, C.height / 5, O, 2, a / 5),
        T(4, C.width / 3, C.height - 55, O, 2, a / 5),
        T(5, C.width / 2, C.height - 47, O, 2, a / 5),
        T(6, C.width / 2, C.height / 10, O, 2, a / 5),
        T(7, C.width / 2, C.height - 40, O, 2, a / 5),
        T(8, C.width / 2, C.height - 45, O, 2, a / 5),
        T(9, C.width / 2, C.height - 35, O, 2, a / 5),
      ];
      var X = 0,
        Y = 180;
...
window.startRandomLuckyNumber = function start(winNumber) {
  setTimeout(() => {
